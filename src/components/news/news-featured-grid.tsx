...
export function NewsFeaturedGrid({
  ...
  return (
    <div
      className={cn(
        newsEnter,
        "grid gap-3 sm:gap-4 lg:grid-cols-[7fr_3fr] lg:items-stretch",
        className,
      )}
    >
      ...
      {secondary.length > 0 ? (
        <div className="grid grid-rows-2 gap-3 sm:grid-rows-4 lg:h-full lg:min-h-0">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        newsGlassHover,
        newsFocus,
        "group flex h-full min-h-[22rem] flex-col overflow-hidden text-left sm:min-h-[26rem] lg:min-h-[28rem]",
        "border-l-[3px]",
        accent,
      )}
    >
      <div className="relative min-h-[12rem] flex-1 overflow-hidden sm:min-h-[14rem]">
        <NewsThumbnail
          article={article}
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[0.75rem] font-semibold uppercase tracking-[0.06em] text-white/75 sm:text-[0.8125rem]">
              Lead story
            </span>
          ...
          <h2 className="mt-2 line-clamp-3 text-[1.125rem] font-semibold leading-snug tracking-[-0.02em] text-white sm:mt-3 sm:text-[1.375rem]">
            {article.headline}
          </h2>
        </div>
      </div>

      <div className="news-glass-inset relative z-[1] flex shrink-0 flex-col gap-3 border-t border-black/[0.06] p-4 sm:p-5">
        <p className="line-clamp-2 text-[0.875rem] leading-relaxed text-neutral-600 sm:text-[0.9375rem]">
          {article.excerpt}
        </p>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        newsFocus,
        newsEnter,
        "group flex h-full min-h-0 items-center gap-3 overflow-hidden p-2.5 text-left sm:gap-3.5 sm:p-3",
        className,
      )}
    >
      <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-lg border border-black/[0.06] sm:h-[3.75rem] sm:w-[3.75rem]">
        <NewsThumbnail
          article={article}
      ...
      <div className="relative z-[1] min-w-0 flex-1">
        <h3 className="line-clamp-2 text-[0.8125rem] font-semibold leading-snug tracking-[-0.01em] text-neutral-950 sm:text-[0.875rem]">
          {article.headline}
        </h3>

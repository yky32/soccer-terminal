...
const LOGO = {
  ...
  frontale: "https://media.api-sports.io/football/teams/294.png",
  kashima: "https://media.api-sports.io/football/teams/281.png",
  fcSeoul: "https://media.api-sports.io/football/teams/2764.png",
  ...
  mexico: "https://media.api-sports.io/football/teams/2283.png",
...
const LEAGUE = {
  ...
  worldCup: "https://media.api-sports.io/football/leagues/1.png",
};
...
const FLAG = {
  ...
  cn: "https://media.api-sports.io/flags/cn.svg",
  world: "https://media.api-sports.io/flags/world.svg",
};
...
export const MOCK_LIVE_MATCHES: LiveMatch[] = [
  ...
  liveMatch({
    ...
    awayGoals: 2,
    homeLogo: LOGO.urawa,
    awayLogo: LOGO.marinos,
    kickoffAt: hoursFromNow(-1.0),
    statusShort: "2H",
    statusLong: "Second Half",
    elapsed: 63,
    league: "J1 League",
  ...
  liveMatch({
    ...
    homeGoals: 0,
    awayGoals: 0,
    homeLogo: LOGO.frontale,
    awayLogo: LOGO.kashima,
    kickoffAt: hoursFromNow(-0.6),
    statusShort: "1H",
    statusLong: "First Half",
    elapsed: 38,
    league: "J1 League",
    ...
    countryCode: "JP",
    countryFlag: FLAG.jp,
    venue: "Uvance Todoroki Stadium, Kawasaki",
    venueCity: "Tokyo",
    latitude: 35.51,
    longitude: 139.72,
    halftimeHome: null,
  ...
  liveMatch({
    ...
    homeGoals: 2,
    awayGoals: 2,
    homeLogo: LOGO.fcSeoul,
    awayLogo: LOGO.ulsan,
    kickoffAt: hoursFromNow(-0.85),
    statusShort: "2H",
    statusLong: "Second Half",
    elapsed: 70,
    league: "K League 1",
  ...
  liveMatch({
    ...
    homeGoals: 1,
    awayGoals: 3,
    homeLogo: LOGO.alHilal,
    awayLogo: LOGO.alNassr,
  ...
  liveMatch({
    ...
    homeGoals: 1,
    awayGoals: 0,
    homeLogo: LOGO.shanghai,
    awayLogo: LOGO.beijing,
    kickoffAt: hoursFromNow(-0.55),
    statusShort: "1H",
    statusLong: "First Half",
    elapsed: 31,
    league: "Super League",
    ...
    countryCode: "CN",
    countryFlag: FLAG.cn,
    venue: "Pudong Football Stadium, Shanghai",
    venueCity: "Shanghai",
    latitude: 31.22,
    longitude: 121.54,
    halftimeHome: null,
  ...
  liveMatch({
    ...
    homeGoals: 1,
    awayGoals: 1,
    homeLogo: LOGO.mexico,
    awayLogo: LOGO.brazil,
    kickoffAt: hoursFromNow(-0.8),
    statusShort: "2H",
    statusLong: "Second Half",
    elapsed: 67,
    league: "World Cup",
    leagueLogo: LEAGUE.worldCup,
    leagueRound: "Group A - 2",
    country: "World",
    countryCode: "WORLD",
    countryFlag: FLAG.world,
...
export const MOCK_FUTURE_MATCHES: LiveMatch[] = [
  ...
  liveMatch({
    ...
    homeGoals: 0,
    awayGoals: 0,
    homeLogo: LOGO.kashima,
    awayLogo: null,
    kickoffAt: hoursFromNow(14),
    statusShort: "NS",
    statusLong: "Not Started",
    elapsed: null,
    league: "J1 League",
  ...
  liveMatch({
    ...
    homeGoals: 0,
    awayGoals: 0,
    homeLogo: LOGO.marinos,
    awayLogo: null,
    kickoffAt: hoursFromNow(36),
    statusShort: "NS",
    statusLong: "Not Started",
    elapsed: null,
    league: "J1 League",
  ...
  liveMatch({
    ...
    homeGoals: 0,
    awayGoals: 0,
    homeLogo: LOGO.alNassr,
    awayLogo: null,
    kickoffAt: hoursFromNow(60),
    statusShort: "NS",
    statusLong: "Not Started",
    elapsed: null,
    league: "Pro League",
  ...
  liveMatch({
    ...
    homeGoals: 0,
    awayGoals: 0,
    homeLogo: LOGO.beijing,
    awayLogo: null,
    kickoffAt: hoursFromNow(80),
    statusShort: "NS",
    statusLong: "Not Started",
    elapsed: null,
    league: "Super League",
